...
export const PulseIndicator = () => {
  ...
  const expo = useImage(require("./img/epyband.png"));
  const heart = useImage(require("./img/expo.png"));
  ...
  return (
    <Canvas style={{ height: 300, width: 300 }}>
      <Circle cx={150} cy={150} r={50} opacity={1} color="#0cc0df"></Circle>
      <Circle cx={150} cy={150} r={scale} opacity={opacity} color="#0cc0df" />
      <Circle cx={150} cy={150} r={scale2} opacity={opacity2} color="#78abbb" />
      <Image
        image={expo}
        fit="contain"
        x={50}
